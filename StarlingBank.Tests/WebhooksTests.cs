...
namespace StarlingBank.Tests
{
    ...
    [Collection("Webhooks Service Tests")]
    public class WebhooksTests : IDisposable, IClassFixture<DependencySetupFixture>
    {
        /// <summary>
        /// The service scope
        /// </summary>
        ...
        public WebhooksTests(DependencySetupFixture fixture)
        {
        ...
        [Trait("Category", "Test Webhooks")]
        [Fact(DisplayName = "Test Getting The Account Holder")]
        public async Task DispatchWebhookAsyncTest()
        {
